...
class CrytoAPI(object):
    ...
    def Get_Crypto_Daily_Price(self, crypto : str, interval : str) -> DataFrame:
        base_url = 'https://www.alphavantage.co/query?'
        ...
        crypto_daily_data_full = crypto_daily_data_full.rename(columns={'1a. open (CNY)':'OPEN (' + self.market_currency + ')', \
        '1b. open (USD)' : 'OPEN (USD)', '2a. high (CNY)':'HIGH (' + self.market_currency + ')', '2b. high (USD)' : 'HIGH (USD)', 
        '3a. low (CNY)':'LOW (' + self.market_currency + ')', '3b. low (USD)':'LOW (USD)', '4a. close (CNY)':'CLOSE (' + self.market_currency + ')', \
